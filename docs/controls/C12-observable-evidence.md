# C12 — Observable and protected evidence

Record requests, authorization decisions, relevant effects, and outcomes in a trace that
can be correlated and reviewed. The executor must not be able to rewrite or erase its own
audit trail.
